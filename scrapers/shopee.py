...
SOURCES = [
    ("https://www.cuponomia.com.br/cupons/shopee", "shopee_cuponomia", "https://www.cuponomia.com.br"),
    ("https://pelando.com.br/tag/shopee", "shopee_pelando", "https://pelando.com.br"),
]
    ...
    for url, prefix, base in SOURCES:
        try:
            ...
            for card in cards[:8]:
                ...
                link = link_el["href"] if link_el else "https://shopee.com.br"
                valid = valid_el.text.strip() if valid_el else "Ver no link"
                title = title_el.text.strip() if title_el else "Cupom Shopee"
